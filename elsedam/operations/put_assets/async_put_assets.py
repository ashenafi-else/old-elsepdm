...
class AsyncPutAssetsOperation(marshalling.AsyncElseOperation):
    """
    Operation for upload assets to storage.
    Get dto with a list of assets, create dam asset and
    put assets files to the storage according to the tags and brands ids.
